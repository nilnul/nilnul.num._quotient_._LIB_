...
namespace nilnul.num.quotient_._recurFrac.denoms.fro_
{
	...
	[Obsolete(nameof(nilnul.num.integer.str_.started_.nonhead8positive._fractile.denoms.of_.dbl_._OfProbX))]
	static public class _FroDblNonnegLeOneX
	{
		...
		{
			return nilnul.num.integer.str_.started_.nonhead8positive._fractile.denoms.of_.dbl_._OfProbX._ToDenoms_0prob(_nonnegLeOne);
