...
{
	[Obsolete(nameof(nilnul.num.integer.str_.started_.nonhead8positive._fractile.denoms.of_.dbl_.probal_.approx_))]
	public class _FroDoubleX
	{
		...
		[Obsolete(nameof(nilnul.num.integer.str_.started_.nonhead8positive._fractile.denoms.of_.dbl_.probal_.approx_._ByIndexX))]

		static public List<Positive1> FroDouble_nonNeg(double _tail_0to1_, N numberOfDenominators)
		{
			return nilnul.num.integer.str_.started_.nonhead8positive._fractile.denoms.of_.dbl_.probal_.approx_._ByIndexX._ToDenoms_0prob(
				_tail_0to1_
				,
		...
		/// <returns></returns>
		///
		[Obsolete(nameof(nilnul.num.integer.str_.started_.nonhead8positive._fractile.denoms.of_.dbl_.probal_.approx_._ByLowerX))]

		static public List<Positive1> FroDouble_atDenominator(double _tail_0to1_, BigInteger denominatorLowerbound_positive)
		{
			return nilnul.num.integer.str_.started_.nonhead8positive._fractile.denoms.of_.dbl_.probal_.approx_._ByLowerX._ToDenoms_0prob_1positive(_tail_0to1_,denominatorLowerbound_positive);
			var denominants = new List<Positive1>();
