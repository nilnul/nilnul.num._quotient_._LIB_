...
namespace nilnul.num.quotient_.radix_.floaty_.dec.of_.quotienty_
{

	static public class _PerMantissaX
	{



		static public radix_.Floaty ToDec(
			this
		...
		)
		{
			...
			return  num.quotient_.radix_.floaty.of_.ofQuotient_._MantissalyX._Of_0radic_2mantissa(10,q,x);
