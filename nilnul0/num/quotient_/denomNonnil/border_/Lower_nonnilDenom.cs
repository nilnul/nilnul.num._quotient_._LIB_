...
namespace nilnul.num.quotient_.denomNonnil.border_
{
	...
	/// </summary>
	public class Lower : nilnul.num.quotient_.denomNonnil.Border
		,
		LowerI
	{
		

		public Lower(bool openFalseCloseTrue, quotient_.DenomNonnilI bound) : base(openFalseCloseTrue, bound)
		{
		}
		...
		static public new Lower CreateOpen(quotient_.DenomNonnilI mark)
		{
			return new Lower(false, mark);
		}

		static public new Lower CreateClose(quotient_.DenomNonnilI mark)
		{
