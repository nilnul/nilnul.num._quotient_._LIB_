...
namespace nilnul.num.quotient_.denomNonnil._range.border.co_
{
	public class LowerUpper
		:
		nilnul.obj.border.co_.LowerUpperA<nilnul.num.quotient_.DenomNonnil, border_.Lower, border_.Upper>
		,
