...
namespace nilnul.num.quotient_.denomNonnil.co.stream_._slider.skid_.nested_._cauchy_
{
	...
	/// </remarks>
	public interface ClampI:quotient_.denomNonnil.co.stream_.nested_._cauchy_.ClampI
	{
		/// <summary>
