...
namespace nilnul.num.quotient_.denomNonnil
{
		...
		
	{
		...
		public _range. border_.Lower lower => new _range. border_.Lower (true, boxed.eeByRef.Item1);

		public _range. border_.Upper upper =>  new _range.border_.Upper(true, boxed.eeByRef.Item2);
