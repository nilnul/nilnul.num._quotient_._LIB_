...
namespace nilnul.num.quotient_.denomNonnil.bound_.closed.stream_._slider.skid_.nested_._cauchy_
{
	...
	/// </remarks>
	public interface ClampI:quotient_.denomNonnil.bound_.closed.stream_.nested_._cauchy_.ClampI
	{
		/// <summary>
