...
namespace nilnul.num.quotient.ext.bound.op
{
	...
	{
		static public ext.bound.be.BasedLower.Expr Eval_lower(

			ext.bound.be.BasedLower.Expr a
			,
			ext.bound.be.BasedLower.Expr b
			
		) {

			return new ext.bound.be.BasedLower.Expr(
				new ext.Bound(
