...
namespace nilnul.num.quotient.ext.border.duo.be_
{
	...
	public partial class Nonempty_Bare
			:
			bit.Be<Duo1>

	{
		static public bool Eval(Duo1 duo)
		{
			...
			return Nonempty.Eval(duo) && duo.NotContainsExtremum();

		}


		public Nonempty_Bare()
				:base(Eval)
			{
		...
		public class En : nilnul.bit.be.Asserted<Duo1, Nonempty_Bare>
		{
