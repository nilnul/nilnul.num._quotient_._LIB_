...
namespace microsoft.num{
    ...
    [Serializable]
    [ComVisible(false)]
	[Obsolete("bug when convert double 181.45 to Rational",true)]
    public struct BigRational : IComparable, IComparable<BigRational>, IDeserializationCallback, IEquatable<BigRational>, ISerializable {
        ...
        public BigRational(Decimal value) {
            ...
            if (bits  is null || bits.Length != 4 || (bits[3] & ~(DecimalSignMask | DecimalScaleMask)) != 0 || (bits[3] & DecimalScaleMask) > (28 << 16)) {
