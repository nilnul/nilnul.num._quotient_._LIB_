...
namespace nilnul.num.quotient.bound_.closed.stream_.slider_.nested_._cauchy_
{
	...
	/// </remarks>
	public interface ClampI:quotient.bound_.closed.stream_.nested_._cauchy_.ClampI
	{
		/// <summary>
