...
{
	[Obsolete()]
    public partial struct SimpleContinuedFraction
        :IComparable<SimpleContinuedFraction>
    {
        int _floor;
        ...
        public SimpleContinuedFraction(int floor,params uint[] denominatorFloors)
        {
            Check(denominatorFloors);
        ...
        static public int Compare(SimpleContinuedFraction a, SimpleContinuedFraction b)
        {
            if (a.floor > b.floor)
            {
                return 1;
        ...
        static private int _compareDenominatorsLongToShort(ref SimpleContinuedFraction a, ref SimpleContinuedFraction b)
        {
        ...
        public int CompareTo(SimpleContinuedFraction other)
        {
